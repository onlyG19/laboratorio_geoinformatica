...
if page == "🏠 Inicio":
    ...
    with col1:
        st.metric("Área Total", "61.2 km²", "Área comunal")

    with col2:
        st.metric("Población", "183,742", "Censo 2017")

    with col3:
        st.metric("Densidad", "3,001 hab/km²", "Densidad poblacional")
    ...
    st.download_button(
        ...
        data="Contenido del PDF aquí".encode('utf-8'),
